...
final class MovieDetailsViewController: DetailsViewController {
    ...
    // MARK: - DetailVC Methods -
    
    override func didTapFavoritesButton() {
...
extension MovieDetailsViewController: MovieDetailsViewInterface {
    func reloadFavorite() {
        setupNavigationBar(isInFavorite: presenter.isInFavorite)
    }
